...
function changeInstr(){
	...
	switch(currStep){
		case 'e_start':
			...
			title = "Empathy";
			text = 	"Welcome to the first step of the process!";
      ...
      ez.show("next-button-bottomflap");
		...
		case 'e_int1':
			title = "Interview";
			text = 	"In this initial step, you will get to understand the user by asking <p id='oequestions' style='display:inline-block;position:static;color:#35b7e5;font-weight:bold;line-size:5vw;margin:0;padding:0;'>open-ended questions</p>.";
